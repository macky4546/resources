...
QBCore.Commands.Add("laprace", "Make a lap race..", {{name="type", help="Which race do you want? (standard, sandy, highway)"}, {name="amount", help="Entry for the race"}}, true, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Commands.Add("startlaprace", "Start the race you made..", {}, false, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Commands.Add("stoplaprace", "Stop the race you made..", {}, false, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local raceId = GetRaceIdByCreator(Player.PlayerData.citizenid)
    if raceId ~= 0 then 
