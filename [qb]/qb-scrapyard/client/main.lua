	...
	if Config.CurrentVehicles ~= nil and next(Config.CurrentVehicles) ~= nil then 
		...
		SetTimeout(math.random(15000, 20000), function()
			...
			TriggerServerEvent('qb-phone:server:sendNewMail', {
				sender = "You dont need to know",
				subject = "Vehicle list",
				message = "I only let you demolish a few vehicles.<br />You can keep everything you demolish for yourself from me as long as you don't bother me.<br /><br /><strong>Vehicle list:</<br />".. vehicleList,
				button = {}
			})
		end)
	else
