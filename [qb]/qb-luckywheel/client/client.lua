...
Citizen.CreateThread(function()
    ...
    if isLoggedIn then
        ...
        local carmodel = GetHashKey('coquette4')
        ...
        Citizen.CreateThread(function()
            ...
            SetEntityCoords(vehicle, _curPos.x, _curPos.y, _curPos.z, false, false, true, true)
            _lambo = vehicle
...
AddEventHandler("esx_tpnrp_luckywheel:winCar", function()
    local vehicleProps = QBCore.Functions.GetVehicleProperties(_lambo)
    TriggerServerEvent('esx_tpnrp_luckywheel:carRedeem', vehicleProps)
end)

RegisterNetEvent("esx_tpnrp_luckywheel:winCarEmail")
AddEventHandler("esx_tpnrp_luckywheel:winCarEmail", function()
...
function doRoll()
    if not _isRolling then
        ...
        local _movePos = vector3(1111.05, 228.66, -49.64)
