...
exports["qb-blackjack"]:SetGetChipsCallback(function(source)
    ...
    exports["qb-blackjack"]:SetTakeChipsCallback(function(source, amount)
        ...
        if Player ~= nil then
            ...
            TriggerEvent("qb-log:server:CreateLog", "casino", "Chips", "yellow", "**"..GetPlayerName(source) .. "** put $"..amount.." on table")
        end
    end)
    ...
    exports["qb-blackjack"]:SetGiveChipsCallback(function(source, amount)
        ...
        if Player ~= nil then
            ...
            TriggerEvent("qb-log:server:CreateLog", "casino", "Chips", "red", "**"..GetPlayerName(source) .. "** got $"..amount.." from table and he won the double")
        end
    end)
end
