...
Config.Locations = {
   ...
   ["armory"] = {
       [1] = {x = 482.76, y = -995.26, z = 30.68, h = 90.654},
       --[2] = {x = -436.82, y = 5996.98, z = 31.716, h = 90.654},
   },   
   ["trash"] = {
       [1] = {x = 484.9836, y = -999.022, z = 30.6898, h = 299.5},
   },      
   ["fingerprint"] = {
       [1] = {x = 485.27, y = -990.11, z = 30.68, h = 358.5},
       --[2] = {x = -442.38, y = 6011.9, z = 27.98, h = 311.5},
   },
   ["evidence"] = {
       [1] = {x = 475.05, y = -996.77, z = 26.27, h = 358.5},
       --[2] = {x = -439.09, y = 6003.12, z = 31.84, h = 90.654},
   },    
   ["evidence2"] = {
       [1] = {x = 472.55, y = -996.75, z = 26.27, h = 90.5},
       --[2] = {x = -439.54, y = 6011.42, z = 27.98, h = 44.5, r = 1.0},
   },   
   ["evidence3"] = {
       [1] = {x = 472.09, y = -992.59, z = 26.27, h = 272.5},
...
Config.AmmoLabels = {
    ["AMMO_PISTOL"] = "9x19mm Ammo",
    ["AMMO_SMG"] = "9x19mm Ammo",
    ["AMMO_RIFLE"] = "7.62x39mm Ammo",
    ["AMMO_MG"] = "7.92x57mm Ammo",
    ["AMMO_SHOTGUN"] = "12-gauge Shells",
