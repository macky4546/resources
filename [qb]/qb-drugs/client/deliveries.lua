                ...
                if dealerDist <= 1.5 and not isHealingPerson then
                    if not interacting then
                        ...
                        elseif dealerIsHome then
                            if dealer["name"] == "old man" then
                                DrawText3D(dealer["coords"]["x"], dealer["coords"]["y"], dealer["coords"]["z"], '[E] To buy in / [G] Help your size ($5000)')
                            else
                                DrawText3D(dealer["coords"]["x"], dealer["coords"]["y"], dealer["coords"]["z"], '[E] To buy / [G] To order')
                            end
                            if IsControlJustPressed(0, Keys["E"]) then
                                buyDealerStuff()
                            end
                            ...
                            if IsControlJustPressed(0, Keys["G"]) then
                                if dealer["name"] == "old man" then
                                    ...
                                    if player ~= -1 and distance < 5.0 then
                                        ...
                                        QBCore.Functions.Progressbar("hospital_revive", "Helping person up..", 5000, false, true, {
                                        ...
                                        QBCore.Functions.Notify("There's no one around..", "error")
                                    end
                                else
                                    if waitingDelivery == nil then
                                        TriggerEvent("chatMessage", "Dealer "..Config.Dealers[currentDealer]["name"], "normal", 'Here you have the products, keep an eye on your mail regarding the order!')
                                        requestDelivery()
                                        interacting = false
                                        dealerIsHome = false
                                    else
