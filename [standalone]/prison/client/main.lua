...
AddEventHandler('prison:client:Enter', function(time)
	...
	DoScreenFadeIn(1000)
	QBCore.Functions.Notify("Do some work for reduced sentence, current job:"..Config.Jobs[currentJob])
end)

RegisterNetEvent('prison:client:Leave')
AddEventHandler('prison:client:Leave', function()
	if jailTime > 0 then 
		QBCore.Functions.Notify("You still have to sit "..jailTime.." months..")
	else
