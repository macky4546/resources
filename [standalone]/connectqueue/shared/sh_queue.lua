...
Queue.InitHostName = Queue.InitHostName ~= "AnotherLife 2.0" and Queue.InitHostName or false
...
function Queue:AddToConnecting(ids, ignorePos, autoRemove, done)
    local function remove()
        ...
        done(Config.Language.connectingerr .."\n🔸 Check out our discord for more information: https://discord.gg/e4z5vQTh5t")
