...
AddBoxZone("PD", vector3(441.79, -982.07, 30.69), 0.4, 0.6, {
	name="PD",
	heading=91,
	debugPoly=false,
	minZ=30.79,
...
RegisterNetEvent('esx_duty:signon')
AddEventHandler('esx_duty:signon',function()
