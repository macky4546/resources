		  ...
		  local Difcords = GetDistanceBetweenCoords(Positie.x, Positie.y, Positie.z, Config.JobData['locations'][k].x, Config.JobData['locations'][k].y, Config.JobData['locations'][k].z, true)
		   if Difcords <= 1.5 then
				...
				elseif Config.JobData['locations'][k]['name'] == 'Driveby' then
					DrawText3D(Config.JobData['locations'][k].x, Config.JobData['locations'][k].y, Config.JobData['locations'][k].z + 0.15, '~g~E~s~ - Buy burgershot Burgers for ~r~$'..Config.BurgerPrice)
	...
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		if HasItem then
			if Config.JobBusy == true then
				...
				QBCore.Functions.Notify("burgershot has been restocked!", "success")
...
Citizen.CreateThread(function()
    ...
    AddTextComponentString("burgershot Outlet")
...
Citizen.CreateThread(function()
    ...
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentSubstringPlayerName("burgershot Storage")
